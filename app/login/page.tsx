...
export default function LoginPage() {
  ...
  async function handleSubmit(event: FormEvent<HTMLFormElement>) {
    ...
    if (signInError) {
      setError("Nao foi possivel entrar. Confira seu e-mail e senha.");
      ...
      <section className="w-full max-w-sm rounded-3xl bg-white p-6 shadow-sm ring-1 ring-stone-200">
        <div className="space-y-3 text-center">
          ...
          <p className="text-sm leading-6 text-stone-600">
            Acesse a lista de desejos que voce compartilha com seu amor.
          </p>
        </div>
        ...
        <p className="mt-6 text-center text-sm text-stone-600">
          Ainda nao tem conta?{" "}
          <Link className="font-semibold text-rose-600" href="/signup">
            Criar conta
          </Link>
        </p>
      </section>
